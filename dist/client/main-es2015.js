...
var map = {
	...
	"./main/callRoom/call-room.module": [
		"./src/app/main/callRoom/call-room.module.ts",
		"default~main-callRoom-call-room-module~messenger-messenger-module",
		"main-callRoom-call-room-module"
	],
	"./main/mainpage/mainpage.module": [
		"./src/app/main/mainpage/mainpage.module.ts",
		"default~main-mainpage-mainpage-module~messenger-messenger-module",
		"main-mainpage-mainpage-module"
	],
	"./messenger/messenger.module": [
		"./src/app/main/mainpage/messenger/messenger.module.ts",
		"default~main-mainpage-mainpage-module~messenger-messenger-module",
		"default~main-callRoom-call-room-module~messenger-messenger-module",
		"messenger-messenger-module"
	]
...
/* harmony default export */ __webpack_exports__["default"] = ("<div style=\"margin-top: 100px;\">\r\n\r\n  <router-outlet></router-outlet>\r\n</div>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-usernav></app-usernav>\r\n<div style=\"margin-top: -20px;\">\r\n\r\n  <router-outlet></router-outlet>\r\n</div>\r\n");
...
/* harmony import */ var _service_token_interceptor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./service/token-interceptor.service */ "./src/app/service/token-interceptor.service.ts");
/* harmony import */ var _main_auth_auth_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./main/auth/auth.service */ "./src/app/main/auth/auth.service.ts");
/* harmony import */ var _main_mainpage_mainpage_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./main/mainpage/mainpage.service */ "./src/app/main/mainpage/mainpage.service.ts");
/* harmony import */ var _main_auth_auth_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./main/auth/auth.component */ "./src/app/main/auth/auth.component.ts");
/* harmony import */ var _main_mainpage_mainpage_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./main/mainpage/mainpage.component */ "./src/app/main/mainpage/mainpage.component.ts");
/* harmony import */ var _main_auth_navbar_navbar_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./main/auth/navbar/navbar.module */ "./src/app/main/auth/navbar/navbar.module.ts");
/* harmony import */ var _main_mainpage_user_navbar_user_navbar_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./main/mainpage/user-navbar/user-navbar.module */ "./src/app/main/mainpage/user-navbar/user-navbar.module.ts");
...
const config = { url: 'https://vartlaaap.herokuapp.com/' };
const AppRoutes = [
    {
        path: 'auth',
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _main_auth_auth_component__WEBPACK_IMPORTED_MODULE_13__["AuthComponent"], _main_mainpage_mainpage_component__WEBPACK_IMPORTED_MODULE_14__["MainPageComponent"]
        ],
        imports: [
            ...
            _main_auth_navbar_navbar_module__WEBPACK_IMPORTED_MODULE_15__["NavBarModule"],
            _main_mainpage_user_navbar_user_navbar_module__WEBPACK_IMPORTED_MODULE_16__["UserNavBarModule"]
        ],
        providers: [{
...
AuthComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-auth',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./auth.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/auth/auth.component.html")).default
    })
], AuthComponent);
...
let AuthService = class AuthService {
    ...
    setSesstion(token) {
        ...
        if (this.token)
            this.socket.emit('connectuser', this.token, window.location.href.includes('room'));
    }
    getToken() {
        return this.token;
    }
...
NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-nav',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./navbar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/auth/navbar/navbar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./navbar.component.css */ "./src/app/main/auth/navbar/navbar.component.css")).default]
    })
], NavbarComponent);
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _navbar_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./navbar.component */ "./src/app/main/auth/navbar/navbar.component.ts");
...
MainPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./mainpage.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/mainpage/mainpage.component.html")).default
    })
], MainPageComponent);
...
MainPageService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], MainPageService);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _mainpage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mainpage.service */ "./src/app/main/mainpage/mainpage.service.ts");




let UserNavbarComponent = class UserNavbarComponent {
    constructor(mainPageService, router) {
        this.mainPageService = mainPageService;
        this.router = router;
        this.loading = true;
    }
    ngOnInit() {
        this.mainPageService.getConnectUser().subscribe((response) => {
            if (response.user)
                this.status = true;
            else
                this.status = false;
...
UserNavbarComponent.ctorParameters = () => [
...
UserNavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-navbar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/main/mainpage/user-navbar/user-navbar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-navbar.component.css */ "./src/app/main/mainpage/user-navbar/user-navbar.component.css")).default]
    })
], UserNavbarComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserNavBarModule", function() { return UserNavBarModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _user_navbar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user-navbar.component */ "./src/app/main/mainpage/user-navbar/user-navbar.component.ts");
...
UserNavBarModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _user_navbar_component__WEBPACK_IMPORTED_MODULE_5__["UserNavbarComponent"]
        ],
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
...
module.exports = __webpack_require__(/*! C:\Users\AA\Desktop\New folder (2)\MEAN---Messenger-Clone\client\src\main.ts */"./src/main.ts");
